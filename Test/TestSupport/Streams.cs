...
{
    /// <summary>An extended <see cref="MemoryStream">memory stream</see> that tracks closing and disposing</summary>
    public class TrackedMemoryStream : MemoryStream
    {
        /// <summary>Initializes a new instance of the <see cref="TrackedMemoryStream"/> class.</summary>
        ...
        /// <summary>Write a short value in Little Endian order</summary>
        ...
        /// <summary>Write an int value in little endian order.</summary>
        /// <param name="value"></param>
    ...
    /// <summary>A <see cref="Stream"/> that cannot seek.</summary>
    ...
    /// <summary>A <see cref="Stream"/> that cannot be read but supports infinite writes.</summary>
    public class NullStream : Stream
    {
        ...
        /// <summary>
        /// When overridden in a derived class, reads a sequence of bytes from the current stream and advances the position within the stream by the number of
        /// bytes read.
        /// </summary>
        /// <param name="buffer">
        ...
        /// <summary>
        /// When overridden in a derived class, writes a sequence of bytes to the current stream and advances the current position within this stream by the
    ...
    /// <summary>
    /// A <see cref="Stream"/> that supports reading and writing from a fixed size memory buffer. This provides the ability to test writing and reading from
    /// very large streams without using any disk storeage
    /// </summary>
    public class WindowedStream : Stream
    {
#if !(NET20 || NET35)

        /// <summary>Initializes a new instance of the <see cref="WindowedStream"/> class.</summary>
        ...
        /// <summary>Not supported, throws <see cref="T:System.NotSupportedException"/>.</summary>
        /// <param name="offset">A byte offset relative to the <paramref name="origin"/> parameter.</param>
        /// <param name="origin">A value of type <see cref="T:System.IO.SeekOrigin"/> indicating the reference point used to obtain the new position.</param>
        /// <returns></returns>
        /// <exception cref="T:System.NotSupportedException">
        ...
        /// <summary>Gets a value indicating whether this instance is closed.</summary>
        /// <value><c>true</c> if this instance is closed; otherwise, <c>false</c>.</value>
        public bool IsClosed => ringBuffer.IsClosed;
        ...
        /// <summary>Gets the bytes read.</summary>
