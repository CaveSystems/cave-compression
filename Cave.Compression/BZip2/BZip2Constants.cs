...
/// <summary>Defines internal values for both compression and decompression.</summary>
static class BZip2Constants
{
    #region Public Fields

    /// <summary>When multiplied by compression parameter (1-9) gives the block size for compression 9 gives the best compression but uses the most memory.</summary>
