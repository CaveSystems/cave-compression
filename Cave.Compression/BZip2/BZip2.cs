...
/// <summary>An example class to demonstrate compression and decompression of BZip2 streams.</summary>
public static class BZip2
{
    #region Public Methods

    /// <summary>Compress the <paramref name="inStream">input stream</paramref> sending result data to <paramref name="outStream">output stream</paramref>.</summary>
    ...
    /// <summary>Decompress the <paramref name="inStream">input</paramref> writing uncompressed data to the <paramref name="outStream">output stream</paramref>.</summary>
