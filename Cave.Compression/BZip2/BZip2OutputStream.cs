...
/// <summary>An output stream that compresses into the BZip2 format including file header chars into another stream.</summary>
public class BZip2OutputStream : Stream
{
    ...
    /// <summary>
    /// Finalizes an instance of the <see cref="BZip2OutputStream"/> class. Ensures that resources are freed and other cleanup operations are performed when the
    ...
    static void Panic() => throw new InvalidDataException("BZip2 output stream panic");
    ...
    */
    ...
    void BsPutIntVS(int numBits, int c) => BsW(numBits, c);

    void BsPutUChar(int c) => BsW(8, c);
    ...
    /// <summary>Initializes a new instance of the <see cref="BZip2OutputStream"/> class.</summary>
    ...
    /// <remarks>Valid block sizes are in the range 1..9, with 1 giving the lowest compression and 9 the highest.</remarks>
    ...
    /// <summary>Gets or sets the number of bytes written to the output.</summary>
    ...
    /// <returns>
    /// The total number of bytes read. This might be less than the number of bytes requested if that number of bytes are not currently available, or zero if
