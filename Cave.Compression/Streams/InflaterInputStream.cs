...
///
/// This stream may form the basis for other decompression filters, such as the <see cref="GZipInputStream">GZipInputStream</see>.
///
...
public class InflaterInputStream : Stream
{
    ...
    /// <summary>Gets or sets the decompressor for this stream.</summary>
    protected Inflater Inflater { get; set; }

    /// <summary>Gets or sets the <see cref="InflaterInputBuffer"/> for this stream.</summary>
    ...
    /// <exception cref="InvalidDataException">Stream ends early.</exception>
    protected void Fill()
    {
    ...
    /// <summary>Initializes a new instance of the <see cref="InflaterInputStream"/> class.</summary>
    /// <remarks>Creates an InflaterInputStream with the default decompressor and a default buffer size of 4KB.</remarks>
    ...
    /// <summary>Initializes a new instance of the <see cref="InflaterInputStream"/> class.</summary>
    /// <remarks>Create an InflaterInputStream with the specified decompressor and a default buffer size of 4KB.</remarks>
    ...
    /// <summary>Initializes a new instance of the <see cref="InflaterInputStream"/> class.</summary>
    /// <remarks>Create an InflaterInputStream with the specified decompressor and the specified buffer size.</remarks>
    /// <param name="baseInputStream">The InputStream to read bytes from.</param>
    ...
    /// <summary>Gets 0 once the end of the stream (EOF) has been reached. Otherwise returns 1.</summary>
    public virtual int Available => Inflater.IsDone ? 0 : 1;

    /// <summary>Gets a value indicating whether the current stream supports reading.</summary>
    public override bool CanRead => baseInputStream.CanRead;

    /// <summary>Gets a value indicating whether seeking is supported for this stream.</summary>
    public override bool CanSeek => false;

    /// <summary>Gets a value indicating whether this stream is writeable.</summary>
    ...
    /// <exception cref="InvalidDataException">Inflater needs a dictionary.</exception>
    ...
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="count">The number of bytes</paramref> to skip is less than or equal to zero.</exception>
