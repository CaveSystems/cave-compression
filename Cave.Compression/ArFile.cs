...
/// <summary>
/// Provides a very simple ar file reader / writer. This calss does not support filenames longer than 15 characters. (Note: may be extended to support BSD style
/// extended filenames).
/// </summary>
public class ArFile
{
    ...
    /// <summary>Creates a new ar file with GZip compression.</summary>
    /// <param name="file">Can be an string containing a path.</param>
    /// <returns>A new <see cref="ArFile"/> instance.</returns>
    ...
    /// <summary>Reads a ar file.</summary>
    ...
    /// <summary>Reads a ar file with GZip compression.</summary>
    /// <param name="file">Name of the file.</param>
    /// <returns>A new <see cref="ArFile"/> instance.</returns>
    ...
    /// <summary>Initializes a new instance of the <see cref="ArFile"/> class.</summary>
    ...
    /// <param name="openRead">If set to true the stream is used for reading and will be checked for a valid header, otherwise a header for a new file is written.</param>
    ...
    /// <summary>reads a header from the ar file throws an EndOfStreamException if the last entry was read already.</summary>
    ...
    /// <summary>reads data from the ar file.</summary>
    ...
    /// <summary>Reads data from the ar file to a specific specified FileName.</summary>
    ...
    /// <summary>skips reading of data from the ar file.</summary>
    ...
    /// <summary>writes a file header to the ar file.</summary>
    ...
    /// <summary>writes a file to the ar file.</summary>
    /// <param name="file">Name of the file.</param>
    ...
    /// <summary>writes data from a specified file to the ar file.</summary>
    /// <param name="file">Name of the file.</param>
    ...
    /// <summary>writes the specified data to the ar file.</summary>
    ...
    /// <summary>lists all entries in the ar file.</summary>
    ...
    /// <summary>closes the ar file.</summary>
    public void Close()
    {
        topStream?.Flush();
#if NETSTANDARD13
    ...
    /// <summary>Gets a simple progress on read operations.</summary>
