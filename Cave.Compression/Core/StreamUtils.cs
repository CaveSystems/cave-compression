...
public static class StreamUtils
{
    ...
    public static void Copy(Stream source, Stream destination, byte[] buffer, ProgressCallback progressHandler, TimeSpan updateInterval, object sender, string name) => Copy(source, destination, buffer, progressHandler, updateInterval, sender, name, -1);
